...
public:
    ...
    */
    ...
    void insererTabDyn (const  TableauDynamique& tab, unsigned int indice);
    /* précondition : indice est un nombre strictement positif et est strictement inférieur à la taille_utilise de de tab*/
    /*postcondition : Les éléments du tableau passé en paramètres sont insérés dans le même ordre, dans le tableau de l'instance à partir de l'indice passé en paramètre. Le tableau tab en paramètre reste inchangé*/
    void AfficherDonnes();
    void ajuster();
    void concatener(TableauDynamique t);
